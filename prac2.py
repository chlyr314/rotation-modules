...
# plot
v0 = pltr(r,v0,n,S,ax,d2flag=False)

# Second rotation
s = np.array([0,0,1])
r,S= get_rotmat(s,dtheta)
v0 = pltr(r,v0,n,S,ax,d2flag=False)
# Rotation of initial vector by product of previous axial vectors 
# to showcase the non-commucative character of finite rots

stot = np.array([0,1,1])
v0 = np.array([1,0,1])*1/np.sqrt(2)
r,S= get_rotmat(stot,dtheta)
v0 = pltr(r,v0,n,S,ax,d2flag=False)
